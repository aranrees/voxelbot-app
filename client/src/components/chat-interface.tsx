  ...
  return (
    <div className={`min-h-screen ${bonkersColors ? bonkersColors.background : 'bg-gray-50 dark:bg-gray-900'} flex flex-col items-center justify-center p-4 transition-colors duration-300`}>
      ...
      <Card className={`w-full ${getWidthClass()} mx-auto shadow-2xl dark:shadow-gray-900/50 border-0 ${bonkersColors ? bonkersColors.chatBg : 'bg-white dark:bg-gray-800'}`}>
        ...
        {/* Chat Messages */}
        <div className={`h-[60vh] sm:h-[50vh] md:h-[42rem] max-h-[calc(100vh-200px)] overflow-y-auto ${sizeClasses.padding} ${sizeClasses.spacing} bg-gray-50 dark:bg-gray-900`}>
          {messages.length === 0 && (
            ...
            >
              ...
              <div
                className={`rounded-2xl ${sizeClasses.padding} shadow-lg ${getMessageBubbleWidth()} ${
                  msg.role === "user"
                    ? `${bonkersColors ? bonkersColors.userMessageBg : 'bg-black dark:bg-gray-700'} rounded-tr-md user-message-bubble`
          ...
          <form onSubmit={handleSendMessage} className="flex space-x-3">
            <div className="flex-1 relative">
              <input
                ...
                className={`w-full ${sizeClasses.input} rounded-xl border shadow-inner px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 chat-input-field`}
                style={{ 
